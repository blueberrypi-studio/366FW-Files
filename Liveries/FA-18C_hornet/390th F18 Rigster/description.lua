livery = {
	...
	{"f18c1", 0 ,"F18C_1_DIFF390",false};
	{"f18c1", ROUGHNESS_METALLIC ,"F18C_1_DIF_RoughMet",true};

	
	{"f18c2", 0 ,"F18C_2_DIFF390",false};
