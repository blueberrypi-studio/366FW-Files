                ...
                if ORD:isExist() then
                    ...
                    if
                        string.find(Table[OrdName].TypeName, '_65') ~= nil or
                            ...
                            string.find(Table[OrdName].TypeName, 'Kh_31') ~= nil or
                            string.find(Table[OrdName].TypeName, 'Kh-31') ~= nil or
                     ...
                     then
                        for Angle = 000, 359, 60 do
                            for Radius = 10, 10, 10 do
                                ...
                                FX_EXPLOSION(Translate, Radius, 350)
                            end
                        end
                    elseif
                    ...
                    if
                     ...
                     then
                        for Angle = 000, 359, 60 do
                            for Radius = 10, 10, 10 do
                                local Translate = Coord:Translate(Radius, Angle)
                                FX_EXPLOSION(Translate, Radius, 150)
                            end
                        end
                    elseif
                     ...
                     then
                        for Angle = 000, 359, 60 do
                            for Radius = 10, 10, 10 do
                                local Translate = Coord:Translate(Radius, Angle)
                                FX_EXPLOSION(Translate, Radius, 200)
                            end
                        end
                    end
                    Table[OrdName].OrdPos = nil
