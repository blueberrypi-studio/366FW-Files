...
ctld.maxDistanceFromCrate = 7.5 -- Maximum distance from from crate for hover
...
ctld.AASystemLimitRED = 40 -- Red side limit

ctld.AASystemLimitBLUE = 40 -- Blue side limit
...
ctld.transportPilotNames = {
    "366th Huey Transport 1",
    "366th Huey Transport 2",
    "366th Huey Transport 3",
    "366th Huey Transport 4",
    "helicargo4",
    "helicargo5",
    "helicargo6",
    "helicargo7",
